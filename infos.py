...
def createStat(username,userdata,isadmin):
    ...
    msg+= '\n\n 🔎Bots de ayuda🔎 \n\n ⏬ Bot para generar enlaces : \n @LinkXGenBot (Renombra automático sin extensión) \n @Link4FilesBot \n @tg_file_link_bot \n @DirectLinkGeneratorbot \n @DirectLinkGen_bot \n @FileToLinkGen_cBot (Lento) \n\n 🔄TransLoader Bot: \n https://five.rapidleech.gq/ (menos de 2 GB) \n https://ten.rapidleech.gq/ (menos de 2 GB) \n https://twenty.rapidleech.gq/  (menos de 2 GB) \n https://eu-amsterdam.rapidleech.gq \n https://eu-frankfurt.rapidleech.gq \n https://rapidleech.gag4n.com \n https://leech13040.herokuapp.com \n https://ss-leech.herokuapp.com \n https://rapidleech-tr.herokuapp.com \n https://loverksleech.herokuapp.com \n \n 🎥 Bot para descargar de YouTube  : \n @VideoYoutubeDL2Bot\n @PlaylistDownloaderBot\n @VideoYoutubeDLBot \n @utuberabot \n @YoutubePlaylistDLBot \n\n ⏫ Bot para subir a Telegram : \n @urluploadxbot \n @UploadsRobot \n @uploadbot \n @CrazyUploadV2Bot \n\n 📦 Bot para Comprimir : \n @FileToZipBot (Funcional) ✅ \n @ArchiverProBot \n @ZipperProBot \n\n 📝 Bot para Renombrar : \n @renamer2bot \n @rnmrbot \n @Renamer_bot \n @RenamerNs_bot \n @Renamer_byAI_Bot \n\n ⚠️ Bot de Notificaciones : \n @ytWatchBot \n'
    return msg
